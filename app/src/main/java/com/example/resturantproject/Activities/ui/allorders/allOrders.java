package com.example.resturantproject.Activities.ui.allorders;
...
public class allOrders extends Fragment {
    ...
    public static com.example.resturantproject.Activities.ui.orders.OrdersFragment newInstance() {
        return new com.example.resturantproject.Activities.ui.orders.OrdersFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        List<Order> orders = orderDataBaseHelper.getAllOrders();
