...
import com.example.resturantproject.databinding.ActivityCustomerBinding;
...
public class Customer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_callfind, R.id.nav_pizzamenu, R.id.nav_favorites
                , R.id.nav_logout, R.id.nav_offers, R.id.nav_orders, R.id.nav_profile)
